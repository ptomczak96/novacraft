...
const TROOPER: UnitDef = {
  parts: [
    ...
    { size: [4.2, 1.4, 0.8], pos: [0, 19.3, 2.6], color: '#000000', emissive: '#33f0ff', emissiveIntensity: 5 },
...
const GUNNER: UnitDef = {
  parts: [
    ...
    { size: [3.8, 1.2, 0.8], pos: [0, 18.2, 2.4], color: '#000000', emissive: '#ff2d95', emissiveIntensity: 5 },
...
const MECH: UnitDef = {
  parts: [
    ...
    // Cyclops visor slit.
    { size: [5.5, 1.6, 0.8], pos: [0, 21.2, 3.6], color: '#000000', emissive: '#33f0ff', emissiveIntensity: 5 },
