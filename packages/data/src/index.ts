...
import type { TerrainType, UnitType, FactionDef, TechDef, GameConfig, DataRegistry } from '@tactica/engine';
...
export { terrainData, unitData, factionData, techData, configData, botConfigData };
